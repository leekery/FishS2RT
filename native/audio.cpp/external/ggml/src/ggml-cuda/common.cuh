...
struct ggml_backend_cuda_context {
    ...
    // One stable raw matrix, allocated only by the opt-in Fish P2 loader before
    // any capture. P2 prefill graphs serialize scratch consumers on stream 0.
    ggml_backend_buffer_t bf16_p2_scratch = nullptr;
    size_t bf16_p2_scratch_bytes = 0;
#endif
